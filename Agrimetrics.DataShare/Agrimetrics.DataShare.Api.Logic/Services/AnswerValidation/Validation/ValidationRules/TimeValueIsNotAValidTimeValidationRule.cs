...
public class TimeValueIsNotAValidTimeValidationRule(
    IResponseFormatter responseFormatter) : IValidationRule
{
    bool IValidationRule.Accepts(QuestionPartAnswerValidationRuleModelData validationRule)
    {
        ...
        return validationRule.QuestionPartAnswerValidationRule_Rule is QuestionPartAnswerValidationRuleId.FreeForm_Time_NotAValidTime;
    }
        ...
        IQuestionAnswerPartResponseForValidation questionAnswerPartResponseForValidation)
    {
        ...
        return !responseFormatter.TryFormatTimeResponse(enteredValue, out _);
    }
}