...
public class DateValueIsNotAValidDateValidationRule(
    IResponseFormatter responseFormatter) : IValidationRule
{
    bool IValidationRule.Accepts(QuestionPartAnswerValidationRuleModelData validationRule)
    {
        ...
        return validationRule.QuestionPartAnswerValidationRule_Rule is QuestionPartAnswerValidationRuleId.FreeForm_Date_NotAValidDate;
    }
        ...
        IQuestionAnswerPartResponseForValidation questionAnswerPartResponseForValidation)
    {
        ...
        return !responseFormatter.TryFormatDateResponse(enteredValue, out _);
    }
}