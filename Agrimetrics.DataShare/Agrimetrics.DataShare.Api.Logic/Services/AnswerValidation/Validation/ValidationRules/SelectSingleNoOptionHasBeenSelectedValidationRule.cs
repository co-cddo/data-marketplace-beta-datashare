...
public class SelectSingleNoOptionHasBeenSelectedValidationRule : IValidationRule
{
    bool IValidationRule.Accepts(QuestionPartAnswerValidationRuleModelData validationRule)
    {
        ...
        return validationRule.QuestionPartAnswerValidationRule_Rule is QuestionPartAnswerValidationRuleId.OptionSelection_SelectSingle_NoOptionIsSelected;
    }
