...
[TestFixture]
public class DateTimeCannotBeInThePastValidationRuleTests
{
    ...
    public void GivenANullValidationRule_WhenICheckAccepts_ThenAnArgumentNullExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.DateTimeCannotBeInThePastValidationRule.Accepts(null!),
            Throws.ArgumentNullException.With.Property("ParamName").EqualTo("validationRule"));
    }

    [Test]
    public void GivenAValidationRuleWithDateTimeCannotBeInThePastRuleId_WhenICheckAccepts_ThenTrueIsReturned()
    {
        var testItems = CreateTestItems();

        var testValidationRule = testItems.Fixture.Build<QuestionPartAnswerValidationRuleModelData>()
            .With(x => x.QuestionPartAnswerValidationRule_Rule, QuestionPartAnswerValidationRuleId.FreeForm_DateTime_DateTimeCannotBeInThePast)
            .Create();

        var result = testItems.DateTimeCannotBeInThePastValidationRule.Accepts(testValidationRule);

        Assert.That(result, Is.True);
    }

    [Test]
    public void GivenAValidationRuleNotWithDateTimeCannotBeInThePastRuleId_WhenICheckAccepts_ThenFalseIsReturned(
    ...
    private static IEnumerable<QuestionPartAnswerValidationRuleId> NonApplicableValidationRuleIds =>
        Enum.GetValues<QuestionPartAnswerValidationRuleId>().Except([QuestionPartAnswerValidationRuleId.FreeForm_DateTime_DateTimeCannotBeInThePast]);
    #endregion
    ...
    public void GivenANullQuestionAnswerPart_WhenICheckWhetherResponseFailsValidation_ThenAnArgumentNullExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.DateTimeCannotBeInThePastValidationRule.ResponseFailsValidation(null!),
    ...
    public void GivenANonFreeFormOptionResponse_WhenICheckWhetherResponseFailsValidation_ThenAnInvalidOperationExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.DateTimeCannotBeInThePastValidationRule.ResponseFailsValidation(questionAnswerPartResponse),
            Throws.InvalidOperationException.With.Message.EqualTo("QuestionAnswerPartResponse is not of expected type for validation rule DateTimeCannotBeInThePastValidationRule"));
    }
    ...
    public void GivenAFreeFormOptionResponseWithAnInvalidDateTime_WhenICheckWhetherResponseFailsValidation_ThenFalseIsReturned()
    {
        ...
        var result = testItems.DateTimeCannotBeInThePastValidationRule.ResponseFailsValidation(questionAnswerPartResponse);

        Assert.That(result, Is.False);
    }

    [Test]
    public void GivenAFreeFormOptionResponseWithDateTimeValueThatIsInThePast_WhenICheckWhetherResponseFailsValidation_ThenTrueIsReturned()
    {
        var testItems = CreateTestItems();
    ...
    [Test]
    public void GivenAFreeFormOptionResponseWithDateTimeValueThatIsNotInThePast_WhenICheckWhetherResponseFailsValidation_ThenTrueIsReturned(
    ...
    private static TestItems CreateTestItems()
    {
        ...
        var dateTimeValueIsNotAValidDateTimeValidationRule = new DateTimeCannotBeInThePastValidationRule(
        ...
        Mock<IClock> mockClock)
    {
        ...
        public IValidationRule DateTimeCannotBeInThePastValidationRule { get; } = dateTimeValueIsNotAValidDateTimeValidationRule;
