...
[TestFixture]
public class TextValueHasNotBeenSuppliedValidationRuleTests
{
    ...
    public void GivenANullValidationRule_WhenICheckAccepts_ThenAnArgumentNullExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.TextValueHasNotBeenSuppliedValidationRule.Accepts(null!),
            Throws.ArgumentNullException.With.Property("ParamName").EqualTo("validationRule"));
    }

    [Test]
    public void GivenAValidationRuleWithTextValueHasNotBeenSuppliedRuleId_WhenICheckAccepts_ThenTrueIsReturned()
    {
        var testItems = CreateTestItems();

        var testValidationRule = testItems.Fixture.Build<QuestionPartAnswerValidationRuleModelData>()
            .With(x => x.QuestionPartAnswerValidationRule_Rule, QuestionPartAnswerValidationRuleId.FreeForm_Text_NoValueSupplied)
            .Create();

        var result = testItems.TextValueHasNotBeenSuppliedValidationRule.Accepts(testValidationRule);

        Assert.That(result, Is.True);
    }

    [Test]
    public void GivenAValidationRuleNotWithTextValueHasNotBeenSuppliedRuleId_WhenICheckAccepts_ThenFalseIsReturned(
    ...
    private static IEnumerable<QuestionPartAnswerValidationRuleId> NonApplicableValidationRuleIds =>
        Enum.GetValues<QuestionPartAnswerValidationRuleId>().Except([QuestionPartAnswerValidationRuleId.FreeForm_Text_NoValueSupplied]);
    #endregion
    ...
    public void GivenANullQuestionAnswerPart_WhenICheckWhetherResponseFailsValidation_ThenAnArgumentNullExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.TextValueHasNotBeenSuppliedValidationRule.ResponseFailsValidation(null!),
    ...
    public void GivenANonFreeFormOptionResponse_WhenICheckWhetherResponseFailsValidation_ThenAnInvalidOperationExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.TextValueHasNotBeenSuppliedValidationRule.ResponseFailsValidation(questionAnswerPartResponse),
            Throws.InvalidOperationException.With.Message.EqualTo("QuestionAnswerPartResponse is not of expected type for validation rule TextValueHasNotBeenSuppliedValidationRule"));
    }
        ...
        [Values("", "  ")] string enteredValue)
    {
        ...
        var result = testItems.TextValueHasNotBeenSuppliedValidationRule.ResponseFailsValidation(questionAnswerPartResponse);
    ...
    private static TestItems CreateTestItems()
    {
        ...
        var textValueHasNotBeenSuppliedValidationRule = new TextValueHasNotBeenSuppliedValidationRule();

        return new TestItems(
            fixture,
            textValueHasNotBeenSuppliedValidationRule);
    }

    private class TestItems(
        IFixture fixture,
        IValidationRule textValueHasNotBeenSuppliedValidationRule)
    {
        public IFixture Fixture { get; } = fixture;
        public IValidationRule TextValueHasNotBeenSuppliedValidationRule { get; } = textValueHasNotBeenSuppliedValidationRule;
    }
    #endregion
}