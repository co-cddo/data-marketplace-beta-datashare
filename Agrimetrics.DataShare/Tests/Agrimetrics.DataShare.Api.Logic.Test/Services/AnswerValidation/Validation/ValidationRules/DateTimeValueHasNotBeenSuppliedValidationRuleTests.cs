...
[TestFixture]
public class DateTimeValueHasNotBeenSuppliedValidationRuleTests
{
    ...
    public void GivenANullValidationRule_WhenICheckAccepts_ThenAnArgumentNullExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.DateTimeValueHasNotBeenSuppliedValidationRule.Accepts(null!),
            Throws.ArgumentNullException.With.Property("ParamName").EqualTo("validationRule"));
    }

    [Test]
    public void GivenAValidationRuleWithDateTimeValueHasNotBeenSuppliedRuleId_WhenICheckAccepts_ThenTrueIsReturned()
    {
        var testItems = CreateTestItems();

        var testValidationRule = testItems.Fixture.Build<QuestionPartAnswerValidationRuleModelData>()
            .With(x => x.QuestionPartAnswerValidationRule_Rule, QuestionPartAnswerValidationRuleId.FreeForm_DateTime_NoValueSupplied)
            .Create();

        var result = testItems.DateTimeValueHasNotBeenSuppliedValidationRule.Accepts(testValidationRule);

        Assert.That(result, Is.True);
    }

    [Test]
    public void GivenAValidationRuleNotWithDateTimeValueHasNotBeenSuppliedRuleId_WhenICheckAccepts_ThenFalseIsReturned(
    ...
    private static IEnumerable<QuestionPartAnswerValidationRuleId> NonApplicableValidationRuleIds =>
        Enum.GetValues<QuestionPartAnswerValidationRuleId>().Except([QuestionPartAnswerValidationRuleId.FreeForm_DateTime_NoValueSupplied]);
    #endregion
    ...
    public void GivenANullQuestionAnswerPart_WhenICheckWhetherResponseFailsValidation_ThenAnArgumentNullExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.DateTimeValueHasNotBeenSuppliedValidationRule.ResponseFailsValidation(null!),
    ...
    public void GivenANonFreeFormOptionResponse_WhenICheckWhetherResponseFailsValidation_ThenAnInvalidOperationExceptionIsThrown()
    {
        ...
        Assert.That(() => testItems.DateTimeValueHasNotBeenSuppliedValidationRule.ResponseFailsValidation(questionAnswerPartResponse),
            Throws.InvalidOperationException.With.Message.EqualTo("QuestionAnswerPartResponse is not of expected type for validation rule DateTimeValueHasNotBeenSuppliedValidationRule"));
    }
        ...
        [Values("", "  ")] string enteredValue)
    {
        ...
        var result = testItems.DateTimeValueHasNotBeenSuppliedValidationRule.ResponseFailsValidation(questionAnswerPartResponse);
    ...
    private static TestItems CreateTestItems()
    {
        ...
        var dateTimeValueHasNotBeenSuppliedValidationRule = new DateTimeValueHasNotBeenSuppliedValidationRule();

        return new TestItems(
            fixture,
            dateTimeValueHasNotBeenSuppliedValidationRule);
    }

    private class TestItems(
        IFixture fixture,
        IValidationRule dateTimeValueHasNotBeenSuppliedValidationRule)
    {
        public IFixture Fixture { get; } = fixture;
        public IValidationRule DateTimeValueHasNotBeenSuppliedValidationRule { get; } = dateTimeValueHasNotBeenSuppliedValidationRule;
    }
    #endregion
}